...
local aloraWatermark = Drawing.new("Text");aloraWatermark.Font = 10;aloraWatermark.Position = Vector2.new(50,24);aloraWatermark.Visible = false;aloraWatermark.Size = 16;aloraWatermark.Color = Color3.new(1,1,1);aloraWatermark.Outline = true
local speclistText = Drawing.new("Text");speclistText.Font = 10;speclistText.Position = Vector2.new(8,305);speclistText.Visible = false;speclistText.Size = 16;speclistText.Color = Color3.new(1,1,1);speclistText.Outline = true
...
function createEsp(plr)
    ...
    boxESP.Thickness = 0.1
    boxESP.Color = Color3.new(255,255,255)
    boxESP.Transparency = 0.1
...
local veloIndicator = Drawing.new("Text");veloIndicator.Center = true;veloIndicator.Outline = true;veloIndicator.Color = Color3.new(1,1,1);veloIndicator.Font = 10;veloIndicator.Size = 15;veloIndicator.Visible = false;veloIndicator.Text = "0"
local wIndicator = Drawing.new("Text");wIndicator.Center = true;wIndicator.Outline = true;wIndicator.Color = Color3.new(1,1,1);wIndicator.Font = 3;wIndicator.Size = 13;wIndicator.Visible = false;wIndicator.Text = "-"
local aIndicator = Drawing.new("Text");aIndicator.Center = true;aIndicator.Outline = true;aIndicator.Color = Color3.new(1,1,1);aIndicator.Font = 3;aIndicator.Size = 13;aIndicator.Visible = false;aIndicator.Text = "-"
local sIndicator = Drawing.new("Text");sIndicator.Center = true;sIndicator.Outline = true;sIndicator.Color = Color3.new(1,1,1);sIndicator.Font = 3;sIndicator.Size = 13;sIndicator.Visible = false;wIndicator.Text = "-"
local dIndicator = Drawing.new("Text");dIndicator.Center = true;dIndicator.Outline = true;dIndicator.Color = Color3.new(1,1,1);dIndicator.Font = 3;dIndicator.Size = 13;dIndicator.Visible = false;dIndicator.Text = "-"
local spaceIndicator = Drawing.new("Text");spaceIndicator.Center = true;spaceIndicator.Outline = true;spaceIndicator.Color = Color3.new(1,1,1);spaceIndicator.Font = 3;spaceIndicator.Size = 13;spaceIndicator.Visible = false;spaceIndicator.Text = "-"
local ctrlIndicator = Drawing.new("Text");ctrlIndicator.Center = true;ctrlIndicator.Outline = true;ctrlIndicator.Color = Color3.new(1,1,1);ctrlIndicator.Font = 3;ctrlIndicator.Size = 13;ctrlIndicator.Visible = false;ctrlIndicator.Text = "-"
...
drawingGroup:addToggle({text = "Drawing Enabled",flag = "drawing_enabled",callback = function()
    while library.flags["drawing_enabled"] do wait()
        ...
        if library.flags["wasd_indicator"] then
            wIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920)
            aIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920) + Vector2.new(-40,25)
            sIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920) + Vector2.new(0,25)
            dIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920) + Vector2.new(40,25)
            spaceIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920) + Vector2.new(40,0)
            ctrlIndicator.Position = Vector2.new(camera.ViewportSize.X/2,camera.ViewportSize.Y-920) + Vector2.new(-40,0)
...
otherGroup:addToggle({text = "Force Crosshair",callback = function()
        g = game.Players.LocalPlayer.PlayerGui.GUI.Crosshairs.Crosshair:GetPropertyChangedSignal("Visible"):Connect(
            function()
...
otherGroup:addToggle({text = "Old sounds",callback = function()
    while true do
	wait(0.5)
	pcall(function()
...
aQ.Center = true
aQ.Outline = true
aQ.Color = Color3.new(255,255,255)
aQ.Font = 10
aQ.Position = Vector2.new(workspace.CurrentCamera.ViewportSize.X / 2, workspace.CurrentCamera.ViewportSize.Y - 220)
aQ.Size = 18
aQ.Visible = true	
...
function onStep()
    ...
    if library.flags["watermark_enabled"] then
        ...
        aloraWatermark.Text = "ev0er | "..ver.." | "..hours..":"..minutes..":"..seconds
    end
end
