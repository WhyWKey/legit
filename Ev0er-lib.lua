...
local menu = game:GetObjects("rbxassetid://8007241295")[1]
...
function library:addTab(name)
    ...
    for i,v in next, library.tabbuttons do
        v.Size = UDim2.new(1/#library.tabbuttons,45,0.25,0)
    end
    ...
    function tab:createGroup(pos)
        ...
        groupbox.BackgroundColor3 = Color3.fromRGB(27,27,27)
        ...
        function group:addToggle(args)
            ...
            box.BorderColor3 = Color3.fromRGB(37,37,37)
            ...
            function toggle(newState)
                state = newState
                box.BackgroundColor3 = state and library.libColor or Color3.fromRGB(31,31,31)
        ...
        function group:addButton(args)
            ...
            button.BorderColor3 = Color3.fromRGB(37,37,37)
        ...
        function group:addSlider(args)
            ...
            slider_2.BorderColor3 = Color3.fromRGB(37,37,37)
            slider_2.Position = UDim2.new(0,0,0,18)
            slider_2.Size = UDim2.new(1,-10,0,18)
            slider_2.AutoButtonColor = false
            slider_2.Font = Enum.Font.Code
            slider_2.Text = ""
            slider_2.TextColor3 = Color3.fromRGB(255,255,255)
            slider_2.TextSize = 14
			
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(65, 65, 65)), ColorSequenceKeypoint.new(0.30, Color3.fromRGB(63, 63, 63)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(30, 30, 30))}
...
UIGradient.Parent = slider_2
        ...
        function group:addList(args)
            ...
            listFrame.BorderColor3 = Color3.fromRGB(37,37,37)
            ...
            function refresh(tbl)
                ...
                for i,v in pairs(tbl) do
                    ...
                    valueButton.BackgroundColor3 = Color3.fromRGB(31,31,31)
